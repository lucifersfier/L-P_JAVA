public class MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println("Fred and George collected "+bagOfSweets1+" and "+bagOfSweets2+ " sweets");
        System.out.println("There are "+ starsInMilkyWay  +" stars in the Milky Way "+ " and "+starsInAndromeda+ " in Andromeda galaxies.");
        ...
        System.out.println("Snape caught the error. Furious, he divided Ron's score to:"+ (testScore/12.0));
